 ...
 * 2016-04-26T15:39:20.336+05:30
 * Generated source version: 2.7.0.redhat-610379
 * 
 */
@WebServiceClient(name = "SOAPService", 
                  wsdlLocation = "file:/home/kkakarla/Development/Camel-Fuse-Examples/testcase-cxf-message-no-cxfbean/cxf-server-hello-world/src/main/resources/META-INF/wsdl/hello_world.wsdl",
...
public class SOAPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/kkakarla/Development/Camel-Fuse-Examples/testcase-cxf-message-no-cxfbean/cxf-server-hello-world/src/main/resources/META-INF/wsdl/hello_world.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SOAPService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/kkakarla/Development/Camel-Fuse-Examples/testcase-cxf-message-no-cxfbean/cxf-server-hello-world/src/main/resources/META-INF/wsdl/hello_world.wsdl");
        }
        WSDL_LOCATION = url;
    }
