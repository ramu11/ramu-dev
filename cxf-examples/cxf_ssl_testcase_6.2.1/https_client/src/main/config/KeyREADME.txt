...
3.vi /tmp/test.cer
4.keytool -printcert -file /tmp/test.cer
5.keytool -importcert -file /tmp/test.cer -keystore /home/kkakarla/Development/camel-fuse-examples/ssl-testcase-6.2.1-working/https_client/src/main/config/clientKeystore.jks -storepass cspass -alias localhost
