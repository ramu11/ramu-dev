...
public class DataSources {
    ...
    private static DataSource mysql() throws Exception {
        // Class<?> dsClass = Class.forName("com.mysql.jdbc.Driver");
        Class<?> dsClass = Class.forName("com.mysql.jdbc.jdbc2.optional.MysqlXADataSource");
        DataSource ds = (DataSource) dsClass.newInstance();
        set(ds, "url", "jdbc.mysql.url");
        set(ds, "user", "jdbc.mysql.user");
        set(ds, "password", "jdbc.mysql.password");
        return ds;
    }
