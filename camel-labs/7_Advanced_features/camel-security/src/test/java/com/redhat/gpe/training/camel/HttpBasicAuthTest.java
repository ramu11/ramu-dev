...
public class HttpBasicAuthTest extends BaseJettyTest {
   ...
   // @Test
    public void testHttpBasicAuth() throws Exception {
        String out = template.requestBody("http4://localhost:{{port}}/test?authMethod=Basic&authUsername=donald&authPassword=duck", "Hello World", String.class);
    ...
    public void testHttpBasicAuthInvalidPassword() throws Exception {
        try {
            template.requestBody("http4://localhost:{{port}}/test?authMethod=Basic&authUsername=donald&authPassword=sorry", "Hello World", String.class);
